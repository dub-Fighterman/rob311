...
class PS4InputHandler(Controller):
    ...
    def on_L3_left(self, value):
        # Ensure the value is negative (or take its absolute and add a negative sign)
    ...
    def on_L2_release(self):
        # Reset left trigger value to the resting state normalized to 0.0
    ...
    def on_R2_release(self):
        # Reset right trigger value to the resting state normalized to 0.0
